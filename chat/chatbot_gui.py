...
# Menu bar
    ...
    # File
     ...
     # username
        ...
        self.send_button = Button(self.send_button_frame, text="Send", width=5, relief=GROOVE, bg='white',
                                  bd=1, command=lambda: self.send_message_insert(None), activebackground="#1c2e44",
        ...
        #refresh
        self.refresh_button = Button(self.send_button_frame, text="Refresh", width=5, relief=GROOVE, bg='white',
                                  bd=1, command=lambda:self.refresh(), activebackground="#263b54",
                                  activeforeground="#000000")
        self.refresh_button.pack(side=LEFT, ipady=8)
        
        self.master.config(bg="#263b54")
        self.text_frame.config(bg="#263b54")
        self.text_box.config(bg="light yellow", fg="black")
        self.entry_frame.config(bg="#263b54")
        self.entry_field.config(bg="light yellow", fg="black", insertbackground="#FFFFFF")
        ...
        self.refresh_button.config(bg="#1c2e44", fg="#FFFFFF", activebackground="#1c2e44", activeforeground="#FFFFFF")
    ...
    def refresh(self):
        root.destroy()
        with open("chatbot_gui.py") as f:
            code = compile(f.read(), "chatbot_gui.py", 'exec')
            exec(code)     
    ...
    def send_message_insert(self, message):
        ...
        #t1.start()
        #time.sleep(1)
        ans=chatbot_response.chat(translation.text)
